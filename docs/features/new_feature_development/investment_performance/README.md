# Investment Performance Docs

이 폴더는 원장 기반 `투자성과 분석` 고도화 작업의 기능별 문서를 모아 둡니다.
...
- `tmp_development_report.md`는 임시 문서입니다. 최종 implementation report가 필요해지면 승격하거나 정리합니다.
- 새 투자성과 관련 문서는 이 폴더에 추가합니다.
